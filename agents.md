...
- Validações executadas: `npm run build` e `cargo check --manifest-path src-tauri/Cargo.toml` passaram, incluindo o ajuste que mescla `binary` + `files` no update remoto.
